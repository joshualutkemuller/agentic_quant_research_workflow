...
from src.pipelines.snowflake_benchmark import run_snowflake_benchmark
...
def parse_args() -> argparse.Namespace:
  ...
  parser.add_argument(
    "--pipeline",
    choices=["daily", "weekly", "monthly", "consumer", "snowflake"],
    required=True,
...
def main() -> None:
  ...
  elif args.pipeline == "snowflake":
    run_snowflake_benchmark(as_of=as_of, repo_root=repo_root)

...
def run_weekly(as_of: date, repo_root: Path) -> None:
  ...
  dashboard_agent.publish_weekly_feeds(data_bundle, model_results)

  print(f"Weekly deep dive written to {summary_path}")
